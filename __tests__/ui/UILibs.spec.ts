...
import { appendDynamicTimestamp, downloadObjectAsJSON } from '../../src/ui/UILibs';
...
describe('downloadObjectAsJSON', () => {
  ...
  it('should parse the object for downloading.', () => {
    expect.assertions(1);
    advanceTo(new Date("2020-05-08 01:23:45"));
    expect(downloadObjectAsJSON({test: 'string', foo: 'bar', export: true, number: 123}, 'TestExport')).toEqual({
      downloadHref: 'data:text/json;charset=urf-8,%7B%0A%20%20%22test%22%3A%20%22string%22%2C%0A%20%20%22foo%22%3A%20%22bar%22%2C%0A%20%20%22export%22%3A%20true%2C%0A%20%20%22number%22%3A%20123%0A%7D',
