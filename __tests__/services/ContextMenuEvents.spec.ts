...
const spyActions: {[s: string]: jest.SpyInstance} = global.generateSpies(Actions);

jest.requireMock('../../src/services/CleanupService');
const spyCleanupService: {[s: string]: jest.SpyInstance} = global.generateSpies(CleanupService);
...
class TestContextMenuEvents extends ContextMenuEvents {
  ...
  public static spyAddNewExpression = jest.spyOn(ContextMenuEvents, 'addNewExpression' as never);
}
...
describe('ContextMenuEvents', () => {
  ...
  describe('menuInit', () => {
    ...
    it('should create its menus contextMenus setting is enabled and none was created beforehand', () => {
      ...
      expect(global.browser.contextMenus.create).toHaveBeenCalledTimes(30);
    ...
    it('should not add another listener if one was already added', () => {
      ...
      ContextMenuEvents.menuInit();
      expect(global.browser.contextMenus.onClicked.addListener).not.toHaveBeenCalled();
    });
  ...
  describe('menuClear', () => {
    it('should work', async () => {
      ...
      expect(global.browser.contextMenus.onClicked.removeListener).toHaveBeenCalledTimes(1);
  ...
  describe('onCreatedOrUpdated', () => {
    it('should show error if failed', () => {
      ...
      expect(spyLib.cadLog.mock.calls[0][0].msg.indexOf('testError')).not.toBe(-1);
  ...
  describe('onContextMenuClicked - aka the big switch statement', () => {
    ...
    it('should show warning through cadLog if menuId given is unknown', () => {
      ...
      expect(spyLib.cadLog.mock.calls[1][0].msg.indexOf('unknown menu id')).not.toBe(-1);
    ...
    it('Trigger Clear All Cookies For This Domain', () => {
      ContextMenuEvents.onContextMenuClicked({
        ...defaultOnClickData,
        menuItemId: ContextMenuEvents.MenuID.CLEAN_COOKIES
      }, sampleTab);
      expect(spyCleanupService.clearCookiesForThisDomain).toHaveBeenCalledTimes(1);
    });
    it('Clear All Cookies For This Domain was clicked, but hostname was blank', () => {
      ContextMenuEvents.onContextMenuClicked({
        ...defaultOnClickData,
        menuItemId: ContextMenuEvents.MenuID.CLEAN_COOKIES
      }, { ...sampleTab, url: 'about:blank' });
      expect(spyCleanupService.clearCookiesForThisDomain).not.toHaveBeenCalled();
    });
    it('Trigger Clear LocalStorage For This Domain', () => {
      ContextMenuEvents.onContextMenuClicked({
        ...defaultOnClickData,
        menuItemId: ContextMenuEvents.MenuID.CLEAN_LOCALSTORAGE
      }, sampleTab);
      expect(spyCleanupService.clearLocalstorageForThisDomain).toHaveBeenCalledTimes(1);
    });
    it('Clear Local Storage For This Domain was clicked, but hostname was blank', () => {
      ContextMenuEvents.onContextMenuClicked({
        ...defaultOnClickData,
        menuItemId: ContextMenuEvents.MenuID.CLEAN_LOCALSTORAGE
      }, { ...sampleTab, url: 'about:blank' });
    ...
    it('Trigger LINK_ADD_GREY_DOMAIN', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('link.cad', ListType.GREY, 'firefox-default');
    });
    it('Trigger LINK_ADD_WHITE_DOMAIN', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('link.cad', ListType.WHITE, 'firefox-default');
    });
    ...
    it('Trigger PAGE_ADD_GREY_DOMAIN', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('page.cad', ListType.GREY, 'firefox-default');
    });
    it('Trigger PAGE_ADD_WHITE_DOMAIN', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('page.cad', ListType.WHITE, 'firefox-default');
    });
    ...
    it('Trigger SELECT_ADD_GREY_DOMAIN', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('selectedText', ListType.GREY, 'firefox-default');
    });
    it('Trigger SELECT_ADD_GREY_DOMAIN and contextualIdentities was enabled', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('selectedText', ListType.GREY, 'firefox-container-1');
    });
    it('Trigger SELECT_ADD_GREY_DOMAIN and contextualIdentities was enabled with no matching container', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('selectedText', ListType.GREY, 'firefox-container-2');
    });
    it('Trigger SELECT_ADD_WHITE_DOMAIN', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('selectedText', ListType.WHITE, 'firefox-default');
    });
    ...
    it('Trigger SELECT_ADD_WHITE_SUBS with multiple comma-separated values', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledTimes(3);
    });
    it('Trigger SELECT_ADD_WHITE_SUBS with whitespaces only', () => {
      ...
      expect(global.browser.i18n.getMessage).toHaveBeenCalledWith('addNewExpressionNotificationFailed');
    ...
    it('Trigger SELECT_ADD_WHITE_SUBS with undefined cookieStoreId (Chrome)', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('*.selectedText', ListType.WHITE, '');
    });
    it('Trigger SELECT_ADD_WHITE_SUBS with undefined inputs to addNewExpression', () => {
      ...
      expect(TestContextMenuEvents.spyAddNewExpression).toHaveBeenCalledWith('*.', ListType.WHITE, '');
    });
